...
# 定数 - 基本的に大文字
# スミツクアクコーポレーションのサーバーID
SEIBARI_GUILD_ID = 993291575973134398
# 検索欄のチャンネルID
TWITTER_SEARCH_CHANNEL_ID = 984734204761899008
# ギラティナのチャンネルID
GIRATINA_CHANNEL_ID = 993387014563041340
# mp3tomp4のチャンネルID
WIP_CHANNEL_ID = 984734463755956304
# ファル子☆おもしろ画像集のチャンネルID
FALCON_CHANNEL_ID = 993387209447178330
# あるくおすしのユーザーID
...
async def inm(ctx):
    await ctx.send(
        ...
        f"ぴよこ「{ctx.author.name}、おっ大丈夫か大丈夫か〜？？？バッチェ冷えてるぞ〜淫夢が大好きだってはっきりわかんぴょね♥」"
    )
