...
# 定数 - 基本的に大文字
# 聖バリ鯖のサーバーID
SEIBARI_GUILD_ID = 984451722258829362
# 検索欄のチャンネルID
TWITTER_SEARCH_CHANNEL_ID = 984451722741182517
# ギラティナのチャンネルID
GIRATINA_CHANNEL_ID = 984451722741182517
# mp3tomp4のチャンネルID
WIP_CHANNEL_ID = 940966825087361025
# ファル子☆おもしろ画像集のチャンネルID
FALCON_CHANNEL_ID = 984451722741182517
# あるくおすしのユーザーID
WALKINGSUSHIBOX_USER_ID = 984451722741182517
# 野獣先輩のユーザーID
TADOKOROKOUJI_USER_ID = 984451722741182517
